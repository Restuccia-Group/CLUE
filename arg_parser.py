...
def parse_args():
    ...
    parser.add_argument("--retain_percentage", type=float, default=0.1)
    ...
    parser.add_argument(
        ...
        default=10,
        type=int,
        help="number of total epochs fortraining the noise for the fast yet effective unlearning",
    )
    ...
    parser.add_argument("--temperature", default=100.0, type=float, help="Temperature for energy unlearning")
    parser.add_argument("--mask_threshold", default=0.1, type=float, help="threshold for calculating the mask from gradient")
    parser.add_argument("--mask_path", default=None, type=str, help="the path of saliency map")
    parser.add_argument("--chenyaofo", default=1, type=int, help="if to use the model from chenyaofo")
